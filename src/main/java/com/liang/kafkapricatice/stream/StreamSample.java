package com.liang.kafkapricatice.stream;
...
public class StreamSample {
    private static final String INPUT_TOPIC="topic-stream-in";
    private static final String OUT_TOPIC="topic-stream-out";

    public static void main(String[] args) {
        Properties props = new Properties();
        props.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG,"ec2-35-73-156-207.ap-northeast-1.compute.amazonaws.com:9092");
